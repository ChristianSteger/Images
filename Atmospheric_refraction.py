...
plt.ylabel("Refraction according to Sæmundsson (1986) [$^{\circ}$]")
plt.legend(frameon=False, loc="upper right", fontsize=12)
fig.savefig(path_plot + "Atmos_refrac_Saemundsson.png", dpi=300,
            bbox_inches="tight")
plt.close(fig)
